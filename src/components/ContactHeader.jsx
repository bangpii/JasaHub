   ...
   <main>
      ...
      >
        <h2
          ...
          data-aos-delay="100"
        >
          Contact <span className="text-[#f49827]">Me</span>
        </h2>
        ...
        <p
          ...
          data-aos-delay="300"
        >
          Ada pertanyaan, kerja sama, atau sekadar ngobrol soal desain ? Kirim pesan saja, Kami sangat senang terhubung denganmu!
        </p>
      </div>
    </main>
  )
