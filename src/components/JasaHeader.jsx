    ...
    <main>
      ...
      >
        <h2
          ...
          data-aos-delay="100"
        >
          Jasa <span className="text-[#f49827]">Me</span>
        </h2>
        ...
        <p
          ...
          data-aos-delay="300"
        >
          Selamat datang di halaman Jasa kami!
          Di sini, Anda dapat menemukan berbagai layanan kreatif yang siap membantu kebutuhan bisnis maupun personal Anda.
        </p>
      </div>

      {/* <img src="/roboto.png" alt="Robot" /> */}
    </main>
  );
};

export default JasaHeader