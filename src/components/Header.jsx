  ...
  return (
    <header className="flex justify-between items-center py-4 px-4 lg:px-20" >
        ...
        <nav className="hidden md:flex items-center gap-12"> 
            <a className="font-poppins text-base tracking-wider transition-colors hover:text-[#f49827] z-50"
             href="#">Home</a>
        ...
        <button className="hidden md:block bg-[#f49827] text-[#010101] py-3 px-8 rounded-full border-none
